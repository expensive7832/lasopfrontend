...
const data = [
    {   
        ...
        courseInfo:[
            ...
            {curr: "Visual Design And Building Prototype", text: "Iterative design means developing higher-fidelity designs as concepts are demonstrated and tested. Get hands-on practice creating wireframes of different fidelities, and use them to build interactive prototypes to test the user experience you have designed. Learn the basics of user interface design to understand how to convert your wireframes into full-fidelity final designs."},
    ...
    {   
        ...
        courseInfo:[
            ...
            {curr: "CSS Application To Your Html", text: "Learn how to link your CSS to HTML so you can begin applying custom styling to your websites. Understand CSS Cascade & Specificity Get hands-on practice exploring the logic behind CSS and how it is interpreted by web browsers, so you can apply custom styles throughout your website."},
            {curr: "Discover CSS Selector", text:"Learn the different CSS selectors and how to use them, allowing you to write clear, purposeful code and fine-tune your styling by selecting specific elements for customization."},
            {curr: "Apply Custom Fonts", text: "Discover how custom fonts are applied to your HTML code using CSS, and practice implementing custom typography within your website."},
            {curr: "Flexible Layout And Web Components", text:"Modern websites feature complex, flexible layouts. Learn how to achieve this within your own code by learning flexbox and more advanced CSS. Explore the concept of components and how they simplify UI design and implementation, and practice applying component thinking to your web development projects."},
            {curr: "Responsive Designs And Web Concept", text:"The modern web is dominated by devices of all shapes and sizes. As a result, responsive design has emerged as the essential process of designing and building webpages to elegantly adapt to any device size, from desktop computers through to mobile phones. Learn how to use media queries to implement responsive design, and explore best practices used in the industry. Finally, explore some advanced web development topics where you can continue your learning beyond the class."},
            {curr: "Javascript", text:"Now, make your websites interactive with Javascript then, understand how to enhance your coding lines with React and Jquery."},
            {curr: "API And Version Control", text:"Learn to fetch data from Rest Api(s) and version control like Git"},
            {curr: "Database Management And Hosting", text:"You will learn SQL database and how to make your application on cloud"},
        ],
        packageBtn:[
            {title: "Entry Requirement",
            info: [
            ...
            {title:"Tuition Fee",
            info: ["N 200,000 for Nigerians", "50% More for foreign students"]},
            {title: "Lectures & Assesments",
            info: [
                "Students should have a personal laptop computer. ",
                "Tuition Fee"
    ...
    {   
        ...
        courseInfo:[
            ...
            {curr: "Javascript", text:"Now, make your websites interactive with Javascript then, understand how to enhance your coding lines with React and Jquery."},
            {curr: "API And Version Control", text:"Learn to fetch data from Rest Api(s) and version control like Git"},
            {curr: "Backend Languages", text:"From Python to Database management, let us train you on how the backend of the web machines works together. Prepare yourself for a complete knowledge and have an advantage over the rest."},
        ],
        packageBtn:[
            {title: "Entry Requirement",
            info: [
    ...
    {   
        ...
        courseInfo:[
            ...
            {curr: "API(s)", text: "Learn how to build and use python Rest API(s) to fetch data to your application"},
            {curr: "Version Control", text:"In this course, you will be taught the concepts of Git and Github."},
            {curr: "Database Management", text: "Database management is an important aspect of every web application and backend programming. Our tutor will take you through the concept of SQL and its integration"},
            {curr: "Deployment & Hosting", text:"Until a web application is deployed to the server, users can't access it. You will learn how to deploy and host your application on cloud"},
    ...
    {   
        ...
        courseInfo:[
            ...
            {curr: "Communicating Data Insights", text: "Completing your data analysis is only the start. Continue your learning path by discovering how to present actionable insights effectively through data visualizations that inform business decisions created with Tableau, the world's leading business analytics platform. Go beyond simply presenting analysis results by learning best practices in storytelling with data and help drive effective decision-making informed by real data insights Highlight Critical Data Insights Build Impactful Visualizations & Dashboards Communicate Captivating Data Narratives"},
            {curr: "Statistics And Modelling", text:"Review important statistical analysis concepts and learn how they apply to data modeling and decision making. Using real data problems encountered in the data science field, learn to build both linear and categorical models, and understand when to use them. Practice applying these techniques to create models that help you make a predictive analysis. Learn Essential Statistical Analysis Concepts Define and Test Your Hypothesis Create Data Science Models"},
            {curr: "Data Analytics Portfolio Project", text:"Showcase everything you’ve learned with a unique portfolio project by completing a real-world analysis on a data set of your choosing. Every week in your Data Science class, you’ll be provided with clear steps to develop your final project. By the end of the course, you’ll have used programming to collect data and complete data wrangling, developed a hypothesis, and modeled your data to prove or disprove it. Finally, you’ll construct a data visualization to present your insights in a meaningful way."},
            // {curr: "Intro To Machine Learning", text:"Machine learning has emerged as a truly disruptive technology and data science capability. Discover common machine learning techniques, and machine learning algorithms, and learn how they’re applied in practical, real-world scenarios. Explore the Fundamentals of Machine Learning Understand Machine Learning Models"},
